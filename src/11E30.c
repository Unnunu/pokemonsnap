...
static Mtx* sProjectionMatrix;
static f32 sScaleX;
static Mtx4f sPerspectiveMatrixF;
static Mtx4f sMvpMatrixF;
static Mtx4f _D_8004AFA8;
static Mtx4f _D_8004AFE8;
static s32 _D_8004B028;
static f32 sScaleY;
static f32 sScaleZ;
static s32 sIsScaleMtxPushed;
static Struct_8004B038* sCustomMatrixHandler;
static Gfx* _D_8004B03C;
static Gfx* _D_8004B040[4];
static Gfx _D_8004B050[60];
static s32 sLevelOfDetail;
static Gfx* _D_8004B238[4];
static Gfx* _D_8004B248;
...
void func_80011268(Mtx* arg0, DObj* arg1, s32 arg2) {
    ...
    cam = omCurrentCamera->children;
    x = arg1->position.v.x - cam->viewMtx.lookAt.xEye;
    y = arg1->position.v.y - cam->viewMtx.lookAt.yEye;
    z = arg1->position.v.z - cam->viewMtx.lookAt.zEye;
...
void func_80014C28(GObjCommon* gobj, Gfx** gfxPtr) {
    s32 ret;
    DObj* dobj;
...
void func_80014D60(GObjCommon* gobj) {
    func_80014C28(gobj, &gMainGfxPos[0]);
}

void func_80014D84(GObjCommon* gobj) {
    func_80014C28(gobj, &gMainGfxPos[1]);
}

void func_80014DA8(GObjCommon* gobj) {
    func_80014C28(gobj, &gMainGfxPos[2]);
}

void func_80014DCC(GObjCommon* gobj) {
...
void func_80014F98(GObjCommon* arg0) {
    sScaleX = sScaleY = sScaleZ = 1.0f;
    sIsScaleMtxPushed = FALSE;
    func_80014DF0(arg0->children);
}
...
void func_800153EC(GObjCommon* obj) {
    DObj* dobj;
...
void func_80015890(GObjCommon* arg0) {
    sScaleX = sScaleY = sScaleZ = 1.0f;
    sIsScaleMtxPushed = FALSE;
    func_80015474(arg0->children);
}

f32 func_800158E8(DObj* arg) {
    f32 x, y, z;
    OMCamera* cam = omCurrentCamera->children;

    x = arg->position.v.x - cam->viewMtx.lookAt.xEye;
    y = arg->position.v.y - cam->viewMtx.lookAt.yEye;
    z = arg->position.v.z - cam->viewMtx.lookAt.zEye;

    return SQ(x) + SQ(y) + SQ(z);
}

void func_80015930(GObjCommon* obj) {
    DObjUnk50_4* unk_50;
    s32 ret;
    DObj* dobj;
...
void func_80015BFC(GObjCommon* obj) {
    DObjUnk50_4* unk_50;
    s32 ret;
    UNUSED s32 temp;
...
void func_80015DD8(GObjCommon* obj) {
    DObjUnk50_5* unk_50;
    UNUSED s32 temp;
    DObj* dobj = obj->children;
...
void func_800161C4(GObjCommon* obj) {
    UNUSED s32 temp[2];
    s32 ret;
    DObjUnk50_5* unk_50;
    DObj* dobj = obj->children;
...
void func_8001679C(GObjCommon* arg0) {
    sScaleX = sScaleY = sScaleZ = 1.0f;
    sIsScaleMtxPushed = FALSE;
    func_80016548(arg0->children);
}
...
void func_80016C88(GObjCommon* arg0) {
    sScaleX = sScaleY = sScaleZ = 1.0f;
    sIsScaleMtxPushed = FALSE;
    func_800167F4(arg0->children);
}
...
void func_80016EA8(GObjCommon* obj) {
    DObjUnk50_4* unk50;
    s32 ret;
    f32 dist;
    DObj* dobj = obj->children;
...
void func_800173E4(GObjCommon* obj) {
    DObj* dobj;
    s32 segaddr;
    s32 ret;
    DObjUnk50_5* unk50;
...
void draw_sprite(GObjCommon* arg0) {
    SObj* sobj = arg0->children;
    while (sobj != NULL) {
        if (!(sobj->sp.attr & SP_HIDDEN)) {
            sobj->sp.rsp_dl_next = gMainGfxPos[0];
            spDraw(&sobj->sp);
            gMainGfxPos[0] = sobj->sp.rsp_dl_next - 1;
        }
        sobj = sobj->next;
    }
}
...
void camera_prepare_matrix(Gfx** gfxPtr, OMCamera* cam) {
            ...
            if (ommtx->unk05 != 2) {
                ...
                switch (ommtx->kind) {
                    ...
                    case MTX_TYPE_LOOKAT_MVIEW:
                        hal_look_at(mtx, cam->viewMtx.lookAt.xEye, cam->viewMtx.lookAt.yEye, cam->viewMtx.lookAt.zEye,
                    ...
                    case MTX_TYPE_LOOKAT_REFLECT_MVIEW:
                        ...
                        hal_look_at_reflect(mtx, lookat, cam->viewMtx.lookAt.xEye, cam->viewMtx.lookAt.yEye,
                                            cam->viewMtx.lookAt.zEye, cam->viewMtx.lookAt.xAt, cam->viewMtx.lookAt.yAt,
    ...
    if (s3 != 0) {
        switch (s3) {
            case 1:
                f2 = sqrtf(SQ(cam->viewMtx.lookAt.zAt - cam->viewMtx.lookAt.zEye) +
                           SQ(cam->viewMtx.lookAt.xAt - cam->viewMtx.lookAt.xEye));
                sp98 = cam->viewMtx.lookAt.yEye;
                sp94 = cam->viewMtx.lookAt.yAt;
                break;
            case 2:
                f2 = sqrtf(SQ(cam->viewMtx.lookAt.yAt - cam->viewMtx.lookAt.yEye) +
                           SQ(cam->viewMtx.lookAt.xAt - cam->viewMtx.lookAt.xEye));
                sp98 = cam->viewMtx.lookAt.zEye;
    ...
    if (spC8 != 0) {
        switch (spC8) {
            case 1:
                f2 = sqrtf(SQ(cam->viewMtx.lookAt.yAt - cam->viewMtx.lookAt.yEye) +
                           SQ(cam->viewMtx.lookAt.zAt - cam->viewMtx.lookAt.zEye));
                sp8C = cam->viewMtx.lookAt.xEye;
                sp88 = cam->viewMtx.lookAt.xAt;
                break;
            case 2:
                f2 = sqrtf(SQ(cam->viewMtx.lookAt.zAt - cam->viewMtx.lookAt.zEye) +
                           SQ(cam->viewMtx.lookAt.xAt - cam->viewMtx.lookAt.xEye));
                sp8C = cam->viewMtx.lookAt.yEye;
...
void camera_render_by_link(GObjCommon* camObj, s32 dlLink, s32 mode) {
    GObjCommon* curr = omGObjListDlHead[dlLink];
...
void func_80018DE8(GObjCommon* obj, s32 dlLink, s32 mode) {
    Gfx* savedGfxPos[4];
    s32 i;
...
void camera_render_objects(GObjCommon* camObj, s32 mode) {
    s32 dlLink = 0;
...
void func_80019158(GObjCommon* obj, Gfx** gfx, s32 arg2) {
    OMCamera* cam = obj->children;
...
void func_800191D8(GObjCommon* obj) {
    func_80019158(obj, &gMainGfxPos[0], 0);
}

void func_80019200(GObjCommon* obj) {
    func_80019158(obj, &gMainGfxPos[1], 1);
}

void func_80019228(GObjCommon* obj) {
    func_80019158(obj, &gMainGfxPos[2], 2);
}

void func_80019250(GObjCommon* obj) {
...
void func_800192DC(GObjCommon* obj) {
    s32 i;
    OMCamera* cam = obj->children;
...
void sprite_camera_render(GObjCommon* obj) {
    OMCamera* cam;
    UNUSED u32 pad;
    s32 xmin, ymin, xmax, ymax;
